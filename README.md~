...
1. Click **Save** on the popup
1. Finally on the pop-up check **No resources need to be updated**
    <p align="left">
      <img width="250" src="https://github.com/charliejllewellyn/aws-serverless-dataprocessing/blob/master/images/codepipeline_no_fresource_update.png">
    </p>
